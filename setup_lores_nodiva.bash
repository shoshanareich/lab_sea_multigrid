...
jobfile=setup_nodiva_optimization.bash

#--- set dir ------------
rootdir=/home/shoshi/MITgcm_c68r/MITgcm/verification/lab_sea

codedir=$rootdir/code_ad_2lev_seaice
builddir_lo=$rootdir/build_ad_2lev_seaice_tapes
inputdir=$rootdir/input_adlo_2lev_seaice

# --- optim ---
#optimdir=$rootdir/OPTIM_2160_nodiva
optimdir=$rootdir/run_ad_2lev_seaice_0000_dv/OPTIM


ext2=$(printf "%04d" $iter)

workdir=/scratch/shoshi/labsea_MG/bathy_tests/run_ad_2lev_seaice_it${ext2}_new_bathy
